...
const TeamSection = () => {
  return (
    <section id="team" className="premium-team-section">
      <div className="container">
        <div className="section-header">
          <span className="subtitle">Clinical Excellence</span>
          <h2 className="main-title">Meet Our Specialists</h2>
          <div className="title-underline"></div>
        </div>

        <div className="team-grid">
          {teamMembers.map((member) => (
            <div key={member.id} className="premium-card">
              ...
              <div className="card-content">
                ...
                <p className="quals">{member.qualifications}</p>
